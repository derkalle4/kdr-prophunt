...
Config = {
    ...
    MinTotalHiderForRevenge = 2, -- 2 - minimal number of hiders which have to be spawned during round before activating mode when AmountHiderForRevenge is reached
